...
import infrared from "../public/infraredAbout.png";
import infraredMobile from "../public/infraredAboutSMall.png";
        ...
        <div className="md:mx-10 mx-2 text-textcolour ">
          {language == "FR" ? (
            <div>
              ...
              <div className="md:text-3xl text-white text-lg px-3 text-balance">
            ...
            <div>
              ...
              <div className="md:text-3xl text-lg text-white px-3 text-balance">
